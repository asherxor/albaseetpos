<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => route('edit_modifier',['id' => $product->id]), 'method' => 'post', 'id' => 'update_add_form' ]) !!}
          
    <div class="modal-header">
      <button type="button"  class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title">@lang( 'cctools::lang.edit_modifier' )</h4>
    </div>
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-default" data-dismiss="modal"></i>@lang( 'cctools::lang.close' )</button>
    </div>
